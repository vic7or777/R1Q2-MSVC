...
EXTERN(struct jpeg_error_mgr *) __cdecl jpeg_std_error
...
EXTERN(void) __cdecl jpeg_CreateCompress JPP((j_compress_ptr cinfo,
				      int version, size_t structsize));
EXTERN(void) __cdecl jpeg_CreateDecompress JPP((j_decompress_ptr cinfo,
					int version, size_t structsize));
...
EXTERN(void) __cdecl jpeg_write_marker
	JPP((j_compress_ptr cinfo, int marker,
	     const JOCTET * dataptr, unsigned int datalen));
/* Same, but piecemeal. */
EXTERN(void) __cdecl jpeg_write_m_header
	JPP((j_compress_ptr cinfo, int marker, unsigned int datalen));
EXTERN(void) __cdecl jpeg_write_m_byte
...
EXTERN(void) __cdecl jpeg_save_markers
	JPP((j_decompress_ptr cinfo, int marker_code,
	     unsigned int length_limit));

/* Install a special processing method for COM or APPn markers. */
EXTERN(void) __cdecl jpeg_set_marker_processor
	JPP((j_decompress_ptr cinfo, int marker_code,
